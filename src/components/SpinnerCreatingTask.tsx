    ...
    >
      <div className="z-20 relative flex flex-col items-center gap-2">
        <div className="relative">
          <svg
            aria-hidden="true"
            className="size-18 animate-spin text-primary-600"
            viewBox="0 0 50 50"
            fill="none"
          >
            <circle
              className="text-(--color-text-default)"
              cx="25"
              cy="25"
              r="20"
              stroke="currentColor"
          ...
          <div className="absolute z-10 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-(--color-text-subtle)">
            <Icon icon={PiNote} size={32} strokeWidth={1.5} />
          </div>
        </div>
