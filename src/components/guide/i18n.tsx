...
const en = {
  ...
  example: {
    ...
    lead: 'Three members, one week. Step through ten real tasks — or hit play — and watch how the engine places each one by skill, who frees up first, priority lanes and the Low cascade. Bar colour = priority.',
    members: [
    ...
    play: 'Play',
    pause: 'Pause',
    start: 'All three members start with an empty week. Create tasks and watch the engine place them.',
    steps: [
      { task: 'Homepage redesign', meta: 'Graphic Design · Normal · 2 days', why: 'Everyone is free, so the engine assigns it — here Member A — blocking Mon and Tue. From now on the others free up sooner than A.' },
      { task: 'Mobile app onboarding', meta: 'UX/UI · Normal · 1 day', why: 'Only Member B holds the UX/UI role, so affinity sends it straight to B — even though A and C are around.' },
      { task: 'Sales one-pager', meta: 'Graphic Design · Normal · 1 day', why: 'A is busy until Tue and B until end of Mon. Member C is free right now and frees up first — the date rule decides.' },
      { task: 'Product launch deck', meta: 'Graphic Design · High · 1 day', why: 'B and C both open up Tuesday. The engine keeps a specialist (C) free and hands the High to the generalist, Member B.' },
      { task: 'Internal newsletter', meta: 'Graphic Design · Low · 1 day', why: 'A Low queues at the very end. Member C’s next free slot is Tuesday, so it lands there (grey bar).' },
      { task: 'Investor deck', meta: 'Graphic Design · Normal · 1 day', why: 'A Normal outranks a Low: it takes C’s Tuesday slot, and the newsletter Low — created today, not started — is PUSHED to Wednesday. “Push, don’t advance.”', highlight: true },
      { task: 'Critical hotfix', meta: 'Graphic Design · Urgent · 1 day', why: 'Urgent has its own lane — it never waits behind Normal or Low work. It slots in at the earliest free moment, Wednesday, on Member B.' },
      { task: 'Promo banner set', meta: 'Graphic Design · Normal · 1 day', why: 'Back to the normal flow: Member A opens up Wednesday and takes it.' },
      { task: 'Webinar deck', meta: 'Graphic Design · Normal · 1 day', why: 'A again — A frees up Thursday and is still the earliest Graphic Design hand.' },
      { task: 'Q3 report cover', meta: 'Graphic Design · High · 1 day', why: 'A High slots in after Member B’s urgent/high work, landing Thursday.' },
    ],
  },
  create: {
    title: 'Create a task',
...
const es: GuideContent = {
  ...
  example: {
    ...
    lead: 'Tres miembros, una semana. Avanza por diez tareas reales —o dale a play— y mira cómo el motor coloca cada una por especialidad, quién se libera primero, carriles de prioridad y la cascada de Low. Color de barra = prioridad.',
    members: [
    ...
    legend: { normal: 'Normal', low: 'Low', high: 'High', urgent: 'Urgent' },
    week: 'Semana del 16 jun',
    prev: 'Atrás',
    next: 'Siguiente tarea',
    reset: 'Reiniciar',
    play: 'Reproducir',
    pause: 'Pausar',
    start: 'Los tres miembros empiezan con la semana vacía. Crea tareas y mira cómo el motor las coloca.',
    steps: [
      { task: 'Rediseño de homepage', meta: 'Graphic Design · Normal · 2 días', why: 'Todos están libres, así que el motor la asigna —aquí a Member A— bloqueando lun y mar. Desde ahora los demás se liberan antes que A.' },
      { task: 'Onboarding de la app móvil', meta: 'UX/UI · Normal · 1 día', why: 'Solo Member B tiene el cargo de UX/UI, así que la afinidad la manda directo a B — aunque A y C estén disponibles.' },
      { task: 'One-pager de ventas', meta: 'Graphic Design · Normal · 1 día', why: 'A está ocupado hasta el martes y B hasta el final del lunes. Member C está libre ahora y se libera primero — decide la regla de la fecha.' },
      { task: 'Deck de lanzamiento', meta: 'Graphic Design · High · 1 día', why: 'B y C se liberan el martes. El motor reserva a un especialista (C) y le da el High al generalista, Member B.' },
      { task: 'Newsletter interno', meta: 'Graphic Design · Low · 1 día', why: 'Un Low hace cola al final del todo. El siguiente hueco de Member C es el martes, así que cae ahí (barra gris).' },
      { task: 'Deck para inversores', meta: 'Graphic Design · Normal · 1 día', why: 'Un Normal manda sobre un Low: toma el hueco del martes de C, y el Low del newsletter —creado hoy, sin empezar— se EMPUJA al miércoles. “Empujar, no adelantar.”', highlight: true },
      { task: 'Hotfix crítico', meta: 'Graphic Design · Urgent · 1 día', why: 'Un Urgent tiene su propio carril — nunca espera tras un Normal o un Low. Entra en el primer hueco libre, el miércoles, en Member B.' },
      { task: 'Set de banners promo', meta: 'Graphic Design · Normal · 1 día', why: 'De vuelta al flujo normal: Member A se libera el miércoles y la toma.' },
      { task: 'Deck del webinar', meta: 'Graphic Design · Normal · 1 día', why: 'A otra vez — A se libera el jueves y sigue siendo la mano de Graphic Design más temprana.' },
      { task: 'Portada del reporte Q3', meta: 'Graphic Design · High · 1 día', why: 'Un High entra tras el trabajo urgent/high de Member B, cayendo el jueves.' },
    ],
  },
  create: {
